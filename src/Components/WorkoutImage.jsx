...
const getWorkoutImage = (exerciseName) => {
  ...
  const imageMap = {
    // Chest exercises
    'chest activation': '/GIF2.0/PVC-Pass-Through-Warm-Up.png',
    'Bodybuilding Full Body Warm-up': '/GIF2.0/quick-warmup-workout-intro.jpg',
    'Light Jogging': '/GIF2.0/image_processing20210527-28008-10h9tz7.gif',
    'light cardio': '/GIF2.0/walking treadmill.gif',
    ...
    'pull ups': '/WorkoutsImage/pull-up.gif',
    'pull-up prep': '/WorkoutsImage/pull-up.gif',
    'assisted pull ups': '/GIF/Assisted-Pull-up.gif',
    ...
    'back extension': '/GIF2.0/back-extension.gif',
    ...
    'cable pull through': '/GIF2.0/Cable-Kneeling-Pull-Through.gif',
    'reverse hyperextension': '/GIF2.0/weighted-hyperextension.gif',
    'nordic curls': '/GIF2.0/Nordic-Hamstring-Curl.gif',
    ...
    'donkey calf raise': '/GIF2.0/donkey-calf-raise.gif',
    ...
    // Arm exercises
    'incline curl': '/WorkoutsImage/INC_DB_CURL.gif',
    ...
    'australian pull ups': '/GIF2.0/Australian-pull-ups-1024x576.jpg',
    'chin ups': '/GIF/chin-ups.gif',
    'archer pull ups': '/GIF2.0/Archer-Pull-Up.webp',
    'back lever progressions': '/GIF/back-lever.webp',
    'muscle up progressions': '/GIF/muscle-ups-movement.gif',
    'planche progressions': '/GIF/Muscles-Planche.001-1.jpeg',
    'bodyweight curl': '/GIF2.0/bodyweight-bicep-curl.gif',
    'towel curl': '/GIF2.0/towel curl.jpg',
    '': '',
    'calisthenics mobility flow': '/GIF2.0/98832341294c89c3b8498d4aca999e64.png',
